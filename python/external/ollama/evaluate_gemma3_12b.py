"""
evaluate_gemma3_12b.py - gemma3:12bを用いたRAGの評価スクリプト

evaluate_ollama_base.pyの基底クラスを継承し、
gemma3:12bモデルを使用してRAGの評価を実行する。
"""
...
class Gemma312BEvaluator(OllamaRAGEvaluator):
    """gemma3:12bを用いたRAGの評価クラス"""

"""
evaluate_gpt-oss_20b.py - gpt-oss:20bを用いたRAGの評価スクリプト

evaluate_ollama_base.pyの基底クラスを継承し、
gpt-oss:20bモデルを使用してRAGの評価を実行する。
"""
...
class GPTOSS20BEvaluator(OllamaRAGEvaluator):
    """gpt-oss:20bを用いたRAGの評価クラス"""

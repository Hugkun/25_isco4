"""
evaluate_gemma3_27b.py - gemma3:27bを用いたRAGの評価スクリプト

evaluate_ollama_base.pyの基底クラスを継承し、
gemma3:27bモデルを使用してRAGの評価を実行する。
"""
...
class Gemma327BEvaluator(OllamaRAGEvaluator):
    """gemma3:27bを用いたRAGの評価クラス"""

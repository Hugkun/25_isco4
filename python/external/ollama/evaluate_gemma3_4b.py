"""
evaluate_gemma3_4b.py - gemma3:4bを用いたRAGの評価スクリプト

evaluate_ollama_base.pyの基底クラスを継承し、
gemma3:4bモデルを使用してRAGの評価を実行する。
"""
...
class Gemma34BEvaluator(OllamaRAGEvaluator):
    """gemma3:4bを用いたRAGの評価クラス"""

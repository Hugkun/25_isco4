"""
evaluate_gpt-oss_120b.py - gpt-oss:120bを用いたRAGの評価スクリプト

evaluate_ollama_base.pyの基底クラスを継承し、
gpt-oss:120bモデルを使用してRAGの評価を実行する。
"""
...
class GPTOSS120BEvaluator(OllamaRAGEvaluator):
    """gpt-oss:120bを用いたRAGの評価クラス"""
